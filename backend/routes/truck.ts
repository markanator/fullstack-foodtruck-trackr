...
//! edit truck
router.put('/:id', [validateTruck, editTruckRequirements], TruckController.editTruck);
//! delete truck
...
// ! EDIT MENU ITEM
router.put('/food/:foodID', [validateFood, editFoodItemRequirements], TruckController.editFood);
// ! DELETE MENU ITEM
