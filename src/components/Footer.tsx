...
function Footer() {
  return (
    <footer className="bg-slate-100 px-5 dark:bg-foreground lg:px-0">
      <div className="container mx-auto py-20">
        <div className="grid grid-cols-1 gap-7 md:grid-cols-2 lg:grid-cols-5 lg:gap-0">
          <div>
            <div className="mb-4 text-base font-semibold text-gray-700 dark:text-gray-100">
              Quick Links
            </div>
            <ul>
              <li className="mb-2">
                <a
                  href="#"
                  className="flex items-center text-sm font-normal text-gray-500 dark:text-gray-400"
                >
                  <svg
          ...
          <div>
            <div className="mb-4 text-base font-semibold text-gray-700 opacity-0 dark:text-gray-100">
              Quick Links
            </div>
            <ul>
              <li className="mb-2">
          ...
          <div>
            ...
            <div className="mb-3 flex">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="mr-2 w-4 flex-shrink-0 text-gray-500 dark:text-gray-400"
                viewBox="0 0 20 20"
                fill="currentColor"
              >
                <path
          ...
          <div className="flex flex-col lg:col-span-2">
            <div className="ml-0 max-w-[482px] lg:ml-auto">
              <h3 className="mb-3 text-2xl font-medium text-gray-700 dark:text-gray-100 lg:text-3xl">
                Subscribe Our Newsletter
              </h3>
              <p className="mb-10 text-base text-gray-500 dark:text-gray-400">
                Get important update to your email.
              </p>
              <div className="shadow-front-4 inline-flex rounded-lg bg-white p-2 text-gray-400 dark:bg-background">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-w-5 mx-2 w-5 shrink-0"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth="2"
                ...
                <input
                  ...
                  className="w-full focus:outline-none dark:bg-background dark:text-gray-400"
                />
                <button
                  type="button"
                  className="ml-0 rounded-lg bg-blue-500 px-4 py-2 text-white hover:bg-blue-600 lg:ml-10"
                >
                  Subscribe
                </button>
              </div>
      ...
      <div className="border-t border-gray-200 py-16 text-center text-base dark:border-background">
        <div className="container mx-auto flex flex-wrap items-center justify-between">
          <p className="mb-4 text-left font-normal text-gray-700 dark:text-gray-400 lg:mb-0">
            Copyright (C) UI Lib 2022. All rights reserved.
          </p>
          <div className="flex flex-wrap">
            <a href="#" className="mr-3 text-gray-400 hover:text-blue-500">
              <svg
